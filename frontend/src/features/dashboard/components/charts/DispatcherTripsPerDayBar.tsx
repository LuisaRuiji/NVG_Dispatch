...
export default function DispatcherTripsPerDayBar({ data, loading }: Props) {
  return (
    <ChartCard title="Trips This Week" loading={loading} empty={data.length === 0} emptyDescription="No trips dispatched this week.">
