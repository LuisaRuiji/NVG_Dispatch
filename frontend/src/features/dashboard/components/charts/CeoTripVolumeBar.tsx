...
export default function CeoTripVolumeBar({ data, loading }: Props) {
  return (
    <ChartCard title="Trip Volume" loading={loading} empty={data.length === 0} emptyDescription="No monthly trip volume data.">
