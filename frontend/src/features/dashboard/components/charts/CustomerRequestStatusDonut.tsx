...
export default function CustomerRequestStatusDonut({ data, loading }: Props) {
  return (
    <ChartCard title="Request Status" loading={loading} empty={data.length === 0} emptyDescription="No active request status data.">
